...
- **Payments** — Tabby, Paymob, Apple Pay
- **Security** — penetration testing, application security (eJPTv2)
...
- **eJPTv2** — INE Junior Penetration Tester
- **PCEP** — Certified Entry-Level Python Programmer
- **KFUPM CTF** — 3rd place, team lead

## Contact

- **Email:** saad.zidoori@gmail.com
- **LinkedIn:** [linkedin.com/in/saad-zidouri](https://linkedin.com/in/saad-zidouri)
